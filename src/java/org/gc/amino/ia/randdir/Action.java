 ...
 * The Class Action.
 * 
 * That class permits to choose an angle and shoot to go that way.
 * It also have a function to keep the current direction with a certain speed.
 */
public class Action {

	/** The number of different directions available. */
	public static final int NB_DIVISIONS = 64;

	/** The minimum speed that the mote must have. */
